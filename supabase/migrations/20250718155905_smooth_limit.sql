/*
  # Extended LuckyCookie.io Database Schema

  1. New Tables
    - `shipping_addresses` - Physical shipping information for prize winners
    - `gumroad_purchases` - Track Gumroad premium cookie purchases
    - `dynamic_prizes` - Dynamic prize inventory from AliExpress API
    - `admin_settings` - Application configuration and settings
    - `webhook_logs` - Log webhook events for debugging
