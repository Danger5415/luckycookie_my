...
export const Admin: React.FC = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-3xl font-bold text-gray-800">{stats.totalCracks}</p>
              <p className="text-gray-600">Cracks Today</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center">
            <ShoppingCart className="h-10 w-10 text-purple-500 mr-4" />
            <div>
              <p className="text-3xl font-bold text-gray-800">{stats.premiumPurchases}</p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Unprocessed Webhooks</span>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-bold text-green-600">${stats.todayRevenue.toFixed(2)}</span>
            </div>
            <div className="flex items-center justify-between">
      ...
      <>
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h4 className="font-bold text-gray-800 mb-2">🔧 Configuration Status</h4>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h4 className="font-bold text-gray-800 mb-2">📊 System Statistics</h4>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div className="text-center">
              <p className="font-bold text-2xl text-blue-600">{stats.totalUsers}</p>
              <p className="text-gray-600">Total Users</p>
            </div>
            <div className="text-center">
              <p className="font-bold text-2xl text-green-600">{stats.totalCracks}</p>
              <p className="text-gray-600">Total Cracks</p>
            </div>
            <div className="text-center">
              <p className="font-bold text-2xl text-purple-600">{stats.premiumPurchases}</p>
              <p className="text-gray-600">Premium Sales</p>
            </div>
            <div className="text-center">
              <p className="font-bold text-2xl text-yellow-600">${stats.monthlyRevenue.toFixed(2)}</p>
              <p className="text-gray-600">Monthly Revenue</p>
            </div>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-red-500 text-white py-3 px-4 rounded-lg font-bold hover:bg-red-600 transition-colors"
            >
              Access Admin Panel
            </button>
          </form>
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cracks</th>
  ...
  const renderWinners = () => (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold text-gray-800">Recent Winners</h3>
        <button
            ...
            {shipments
              ...
              .map((shipment) => (
                <tr key={shipment.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-gray-900">{shipment.full_name}</div>
                      <div className="text-sm text-gray-500">{shipment.email}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{shipment.dynamic_prizes?.name || 'Unknown Prize'}</div>
                    <div className="text-sm text-gray-500">${shipment.dynamic_prizes?.price_usd || 0}</div>
                  </td>
  ...
  const renderPrizes = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-bold text-gray-800">Static Prize Inventory</h3>
          <button
            ...
            <div key={prize.id} className="flex items-center justify-between p-3 border rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">${prize.price_usd}</p>
                </div>
              </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-bold text-gray-800">Manual Prizes (Database)</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {dynamicPrizes.map((prize) => (
            <div key={prize.id} className="border rounded-lg p-4">
              ...
              />
              <h4 className="font-medium text-sm mb-1">{prize.name}</h4>
              <p className="text-xs text-gray-600 mb-2">{prize.tier.toUpperCase()} Tier</p>
              <p className="font-bold text-green-600">${prize.price_usd}</p>
        ...
        {dynamicPrizes.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">No manual prizes found in the database.</p>
            <p className="text-sm text-gray-500">Add prizes manually through the database or static prizes section.</p>
          </div>
        )}
      </div>
    </div>
  ...
  const renderSettings = () => (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h3 className="text-xl font-bold text-gray-800 mb-6">Application Settings</h3>
        ...
        <div>
          ...
          {activeTab === 'purchases' && (
            <div className="bg-white rounded-xl shadow-lg">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <h3 className="text-xl font-bold text-gray-800">Premium Purchases</h3>
                  <div className="flex space-x-2">
                    <select
                      value={filterStatus}
                      onChange={(e) => setFilterStatus(e.target.value)}
                    ...
                    {purchases
                      ...
                      .map((purchase) => (
                        <tr key={purchase.id}>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div>
                              <div className="text-sm font-medium text-gray-900">{purchase.email}</div>
                              <div className="text-sm text-gray-500">Sale ID: {purchase.sale_id}</div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">{purchase.product_name}</div>
                            <div className="text-sm text-gray-500">{purchase.tier.toUpperCase()} Tier</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ${purchase.price_usd}
                          </td>
      ...
      {showAddPrize && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold">Add New Prize</h3>
              <button
            ...
            <form onSubmit={handleAddPrize} className="space-y-4">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <label className="text-sm text-gray-700">Premium Prize</label>
              </div>
