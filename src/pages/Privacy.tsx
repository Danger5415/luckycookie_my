      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8">
          <div className="flex items-center mb-6">
            <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-green-500 mr-2 sm:mr-3" />
            <h2 className="text-xl sm:text-3xl font-bold text-gray-800">Privacy Policy</h2>
          </div>

          <div className="prose max-w-none">
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
              <div className="flex items-start">
                <Lock className="h-4 w-4 sm:h-5 sm:w-5 text-green-600 mr-2 mt-0.5" />
                <div>
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">1. Information We Collect</h3>
              
              <h4 className="text-base sm:text-xl font-semibold text-gray-800 mb-2 sm:mb-3">Personal Information</h4>
              ...
              <h4 className="text-base sm:text-xl font-semibold text-gray-800 mb-2 sm:mb-3">Usage Information</h4>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">2. How We Use Your Information</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">3. Information Sharing</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">4. Data Security</h3>
              <div className="flex items-start mb-4">
                <Database className="h-5 w-5 sm:h-6 sm:w-6 text-blue-500 mr-2 sm:mr-3 mt-1" />
                <div>
                  <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">5. Your Rights and Choices</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">6. Cookies and Tracking</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">7. Data Retention</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">8. Children's Privacy</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">9. International Data Transfers</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">10. Changes to This Policy</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
            ...
            <section className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">11. Contact Us</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
